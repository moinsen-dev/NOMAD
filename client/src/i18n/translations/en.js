const en = {
  ...
  'discover.subtitle': 'AI-powered recommendations',
  'discover.getRecommendations': 'Get Recommendations',
  'discover.loading': 'AI is thinking...',
  'discover.error': 'Could not get recommendations',
  'discover.retry': 'Try again',
  'discover.empty': 'No recommendations yet. Click the button above to get started.',
  'discover.emptyHint': 'Click "Get Recommendations" to discover places that match your group\'s preferences.',
  'discover.notConfigured': 'AI is not configured. Ask your admin to set it up in the admin panel.',
  'discover.dayFilter': 'Filter by day',
  'discover.day': 'Day',
  'discover.allDays': 'All days',
  'discover.customPrompt': 'What are you looking for?',
  'discover.customPromptPlaceholder': 'e.g., Something for a rainy day, kid-friendly activities...',
  'discover.promptPlaceholder': 'e.g., Something for a rainy day, kid-friendly activities...',
  'discover.fetchError': 'Could not get recommendations',
  'discover.cachedResults': 'Showing cached recommendations',
  'discover.abort': 'Stop',
  'discover.showOnMap': 'Show on Map',
  'discover.addToTrip': 'Add to Trip',
  'discover.addedToTrip': 'Place added to trip!',
  'discover.duration': 'Duration',
  'discover.price': 'Est. price',
  'discover.bestTime': 'Best time',
  'discover.why': 'Why this fits',
  'discover.rateLimited': 'Too many requests. Please wait a moment.',
  'discover.cached': 'Showing cached recommendations',
  'discover.noDestination': 'Add a place first so AI knows where to recommend.',

  // Preferences (settings.* keys used by PreferencesSection component)
  'settings.travelPreferences': 'Travel Preferences',
  'settings.interests': 'Interests',
  'settings.interest.culture': 'Culture',
  'settings.interest.food': 'Food',
  'settings.interest.outdoor': 'Outdoor',
  'settings.interest.nightlife': 'Nightlife',
  'settings.interest.adventure': 'Adventure',
  'settings.interest.relaxation': 'Relaxation',
  'settings.interest.family': 'Family',
  'settings.budgetLevel': 'Budget Level',
  'settings.budget.budget': 'Budget',
  'settings.budget.medium': 'Medium',
  'settings.budget.luxury': 'Luxury',
  'settings.foodPreferences': 'Food Preferences',
  'settings.food.vegetarian': 'Vegetarian',
  'settings.food.vegan': 'Vegan',
  'settings.food.halal': 'Halal',
  'settings.food.kosher': 'Kosher',
  'settings.food.local_cuisine': 'Local Cuisine',
  'settings.avoid': 'Avoid',
  'settings.avoidPlaceholder': 'Type something and press Enter...',
  'settings.mobility': 'Mobility',
  'settings.mobility.full': 'Full mobility',
  'settings.mobility.limited': 'Limited mobility',
  ...
  'admin.ai.subtitle': 'Configure AI provider for smart recommendations',
  'admin.ai.provider': 'Provider',
  'admin.ai.providerNone': 'Disabled',
  ...
  'admin.ai.modelPlaceholder': 'e.g., llama3.1, gpt-4o-mini, claude-sonnet-4-5-20250514',
  'admin.ai.testConnection': 'Test Connection',
  'admin.ai.connected': 'Connected',
  'admin.ai.connectionFailed': 'Connection failed',
  'admin.ai.save': 'Save Configuration',
  'admin.ai.saved': 'AI configuration saved!',
}
