const de = {
  ...
  'discover.subtitle': 'KI-gestützte Empfehlungen',
  'discover.getRecommendations': 'Empfehlungen laden',
  'discover.loading': 'KI denkt nach...',
  'discover.error': 'Empfehlungen konnten nicht geladen werden',
  'discover.retry': 'Erneut versuchen',
  'discover.empty': 'Noch keine Empfehlungen. Klicke auf den Button oben, um loszulegen.',
  'discover.emptyHint': 'Klicke auf "Empfehlungen laden", um Orte zu entdecken, die zu euren Präferenzen passen.',
  'discover.notConfigured': 'KI ist nicht konfiguriert. Bitte den Admin, es im Admin-Panel einzurichten.',
  'discover.dayFilter': 'Nach Tag filtern',
  'discover.day': 'Tag',
  'discover.allDays': 'Alle Tage',
  'discover.customPrompt': 'Wonach sucht ihr?',
  'discover.customPromptPlaceholder': 'z.B. Etwas für einen Regentag, kinderfreundliche Aktivitäten...',
  'discover.promptPlaceholder': 'z.B. Etwas für einen Regentag, kinderfreundliche Aktivitäten...',
  'discover.fetchError': 'Empfehlungen konnten nicht geladen werden',
  'discover.cachedResults': 'Zeige zwischengespeicherte Empfehlungen',
  'discover.abort': 'Abbrechen',
  'discover.showOnMap': 'Auf Karte zeigen',
  'discover.addToTrip': 'Zum Trip hinzufügen',
  'discover.addedToTrip': 'Ort zum Trip hinzugefügt!',
  'discover.duration': 'Dauer',
  'discover.price': 'Gesch. Preis',
  'discover.bestTime': 'Beste Zeit',
  'discover.why': 'Warum das passt',
  'discover.rateLimited': 'Zu viele Anfragen. Bitte warte einen Moment.',
  'discover.cached': 'Zeige zwischengespeicherte Empfehlungen',
  'discover.noDestination': 'Füge zuerst einen Ort hinzu, damit die KI weiß, wo sie empfehlen soll.',

  // Präferenzen (settings.* keys used by PreferencesSection component)
  'settings.travelPreferences': 'Reise-Präferenzen',
  'settings.interests': 'Interessen',
  'settings.interest.culture': 'Kultur',
  'settings.interest.food': 'Essen',
  'settings.interest.outdoor': 'Outdoor',
  'settings.interest.nightlife': 'Nachtleben',
  'settings.interest.adventure': 'Abenteuer',
  'settings.interest.relaxation': 'Entspannung',
  'settings.interest.family': 'Familie',
  'settings.budgetLevel': 'Budget-Level',
  'settings.budget.budget': 'Günstig',
  'settings.budget.medium': 'Mittel',
  'settings.budget.luxury': 'Luxus',
  'settings.foodPreferences': 'Essens-Präferenzen',
  'settings.food.vegetarian': 'Vegetarisch',
  'settings.food.vegan': 'Vegan',
  'settings.food.halal': 'Halal',
  'settings.food.kosher': 'Koscher',
  'settings.food.local_cuisine': 'Lokale Küche',
  'settings.avoid': 'Vermeiden',
  'settings.avoidPlaceholder': 'Eingeben und Enter drücken...',
  'settings.mobility': 'Mobilität',
  'settings.mobility.full': 'Volle Mobilität',
  'settings.mobility.limited': 'Eingeschränkte Mobilität',
  'settings.savePreferences': 'Präferenzen speichern',
  'settings.toast.preferencesSaved': 'Präferenzen gespeichert!',

  // Admin KI-Konfiguration
  'admin.tabs.ai': 'KI',
  'admin.ai.title': 'KI-Konfiguration',
  'admin.ai.subtitle': 'KI-Anbieter für smarte Empfehlungen konfigurieren',
  'admin.ai.provider': 'Anbieter',
  'admin.ai.providerNone': 'Deaktiviert',
  'admin.ai.providerOllama': 'Ollama (Self-hosted)',
  'admin.ai.providerOpenAI': 'OpenAI',
  'admin.ai.providerAnthropic': 'Anthropic',
  'admin.ai.endpoint': 'Endpoint-URL',
  'admin.ai.apiKey': 'API-Schlüssel',
  'admin.ai.model': 'Modell',
  'admin.ai.modelPlaceholder': 'z.B. llama3.1, gpt-4o-mini, claude-sonnet-4-5-20250514',
  'admin.ai.testConnection': 'Verbindung testen',
  'admin.ai.connected': 'Verbunden',
  'admin.ai.connectionFailed': 'Verbindung fehlgeschlagen',
  'admin.ai.save': 'Konfiguration speichern',
  'admin.ai.saved': 'KI-Konfiguration gespeichert!',
}
